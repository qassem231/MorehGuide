...
export default function SaveBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gray-50 dark:bg-brand-dark border-t border-gray-200 dark:border-brand-slate/30 backdrop-blur-lg p-4 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] transition-colors duration-300">
