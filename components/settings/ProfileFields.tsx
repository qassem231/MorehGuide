...
export default function ProfileFields({
  ...
  return (
    <div className="space-y-4">
      <div className="bg-gray-50 dark:bg-brand-slate/20 backdrop-blur-lg border border-gray-200 dark:border-white/10 rounded-xl p-6 shadow-sm dark:shadow-none transition-colors duration-300">
        <label
          htmlFor="full-name"
